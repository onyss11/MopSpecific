<header>
    <div class="headerBar">
        ...
        <a href="index.php"><img src="assets/img/logo.png" alt="" class="brandLogo" ></img></a>
                ...
                <nav class="navMain" id="navMain">
                    ...
                    <!--<li class="navItem"><a href="#" class="navLink">
                        ...
                        <?php if (!isset($_SESSION['user'])): ?>
                            <li class="navItem"><a href="index.php" class="navLink">Inicio</a></li>
                        ...
                        <?php elseif($_SESSION['user']['id_permissions'] == 2): ?>
                            ...
                            <li class="navItem"><a href="dashUser.php" class="navLink">Guardados</a></li>
                            <li class="navItem"><a href="functions/conexionOff.php" class="navLink">Logout</a></li>
                        <?php endif; ?>
