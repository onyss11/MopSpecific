<?php  
    ...
    if (!isset($_SESSION['user'])){
		...
		if(isset($_REQUEST)){
			...
			$tuserFound = $db->prepare("SELECT modelo.id_modelo, modelo.id_marca, modelo.namMdelo, marca.naMarca FROM modelo INNER JOIN marca ON modelo.id_marca = marca.id_marca");
			$tuserFound->execute();
...
<body>
    ...
    <div class="container containerSearch">
        <div class="card bg-light">
            <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Productos</strong> <a href="addproduct.php" class="float-end btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Agregar producto</a></div>
            <div class="card-body">
            <table class="table table-hover">
				...
				<tbody class="table-light ">
					...
					<tr>
						<td><?php echo $s;?></td>
						<td><?php /*if($userData['id_marca'] === '1'){ echo 'popo'; }else{*/echo $userData['naMarca'];/*}*/ ?></td>
						...
						<td align="center">
							...
							<!--<a href="specifics.php?editId=<?php echo $userData['id_especificacion'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Editar</a> |!--> 
